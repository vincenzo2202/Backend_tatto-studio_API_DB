...
import { createAppointment, deleteAppointment, getAllArtist, getAllMyAppointment, getallAppointmentSuperAdmin, updateAppointment } from "../controllers/appointmentControllers";
